...
<body class="bg-gray-50 font-sans antialiased">
    ...
    <strong class="text-[#FFFFFF]">Última actualización:</strong> <span class="text-[#FFFFFF]">{{ date('d/m/Y') }}</span>
            ...
            <div class="prose max-w-none">
                ...
                <p class="text-[#000000]">En <strong>{{ config('app.name', 'Nuestra Aplicación') }}</strong>, nos comprometemos a proteger tu privacidad. Recopilamos la siguiente información:</p>
                ...
                <p class="text-[#000000]">Utilizamos la información recopilada para los siguientes propósitos:</p>
                
                <div class="grid md:grid-cols-2 gap-4 mt-4">
                    <div class="bg-[#241178] bg-opacity-10 p-4 rounded-lg">
                        <h3 class="font-semibold text-[#241178] mb-2">Para Usuarios</h3>
                        <ul class="text-sm space-y-1 text-[#000000]">
                    ...
                    <div class="bg-[#4CAF50] bg-opacity-10 p-4 rounded-lg">
                        <h3 class="font-semibold text-[#4CAF50] mb-2">Para Establecimientos</h3>
                        <ul class="text-sm space-y-1 text-[#000000]">
                ...
                <p class="text-[#000000]">Implementamos medidas de seguridad robustas para proteger tu información:</p>
                ...
                <p class="text-[#000000]"><strong>No vendemos tu información personal.</strong> Solo compartimos datos en los siguientes casos:</p>
                ...
                <p class="text-[#000000]">Tienes derecho a:</p>
                
                <div class="bg-[#241178] bg-opacity-10 p-4 rounded-lg mt-2">
                    <div class="grid md:grid-cols-2 gap-3 text-sm">
                        <div class="flex items-center text-[#000000]">
                            <span class="w-2 h-2 bg-[#241178] rounded-full mr-2"></span>
                ...
                <p class="text-[#000000]">Utilizamos cookies para mejorar tu experiencia:</p>
                ...
                <p class="text-[#000000]">Podemos actualizar esta política periódicamente. Te notificaremos sobre cambios significativos a través de:</p>
                ...
                <div class="bg-[#241178] bg-opacity-10 p-4 rounded-lg mt-2">
                    <p class="text-[#000000]">Si tienes preguntas sobre esta política de privacidad, contáctanos:</p>
                    <div class="mt-2 space-y-1 text-[#000000]">
                ...
                <div class="mt-8 p-4 bg-[#241178] bg-opacity-10 rounded-lg text-center">
    ...
    <footer class="bg-[#FFFFFF] border-t mt-8">
        <div class="max-w-4xl mx-auto py-6 px-4 text-center text-[#000000]">
            ...
            <div class="mt-2 space-x-4">
                ...
                <a href="{{ route('terms') }}" class="text-[#241178] hover:text-[#1a0d5a] text-sm">Términos y Condiciones</a>
            </div>
        </div>
    </footer>
</body>
